...
\simpleheader{titleBackColor}{彥翔}{林}{2024 碩士應屆畢業生｜英國伯明翰大學｜多益：955｜雅思學術：7｜歐盟航空安全總署 Part-147 核准證書}{white}
...
\adjustbox{valign=t}{\begin{minipage}{6.7cm}
    ...
    \newline
    作為一名英國伯明翰大學的碩士應屆畢業生，我擁有高度的上進心和適應能力。我的學經歷雖然非比尋常，但卻讓我獨特地擁有了結合精準、嚴謹技術和創新的多樣化技能。從複雜的飛機修護到最前沿的電腦科學，我在硬體和軟體兩方面都建立了穩固的基礎，渴望將這種獨特的融合帶入半導體產業。
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\adjustbox{valign=t}{\begin{minipage}{13.1cm}
    ...
    \end{itemize}
    \end{multicols}
    \textbf{模組總平均：59\%；專案提案：75\%；專案答辯：60\%；論文：Pass}}
    {\icon{Python} Python,\icon{flask} Flask,\icon{HTML5} HTML,\icon{Bootstrap} Bootstrap,\icon{CSS3} CSS,\icon{Sqlite} SQLite,\icon{Git} git,{\includegraphics[align=c, height=9.5pt]{PIC/Ubuntu.png}} Ubuntu, \LaTeX}
