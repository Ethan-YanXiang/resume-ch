...
\adjustbox{valign=t}{\begin{minipage}{13.1cm}
    ...
    {\icon{Python} Python,\icon{flask} Flask,\icon{HTML5} HTML,\icon{Bootstrap} Bootstrap,\icon{CSS3} CSS,\icon{Sqlite} SQLite,\icon{Git} git,{\includegraphics[align=c, height=9.5pt]{PIC/Ubuntu.png}} Ubuntu,\icon{Latex.png} \LaTeX}
